  ...
  return (
    <div className="section" id="teacher">
      <div className="grid sm:grid-cols-2 place-items-center gap-8">
        ...
        <div className="p-4 md:w-3/4 sm:row-start-1 shadow-lg	">
        ...
        <div className="p-4 md:w-3/4 shadow-lg	">
          <img src={teacher2} alt="" />
        </div>
      </div>
      <div className="text-center mt-10 my-8 font-bold sm:text-[1.875rem] text-[1.5rem]">
